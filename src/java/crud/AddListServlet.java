...
public class AddListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddListServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            lists list = new lists(lName, lGender, lEmail, lAddress);
            try{
                listDao lDao = new listDao(ConnectionDb.getCon());
                if(lDao.addList(list)){

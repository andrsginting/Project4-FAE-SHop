 ...
 * @author Andreas PC
 */
@WebServlet(name = "EditListServlet", urlPatterns = {"/EditListServlet"})
public class EditListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditListServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            list.setListgender(lGender);
            list.setListEmail(lEmail);
            list.setListAddress(lAddress);
            list.setId(id);
